...
CLASS zcl_054906_travel_generator IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA travel   TYPE z054906travel_a.
    DATA travels  TYPE TABLE OF z054906travel_a.
    DATA booking  TYPE z054906booking_a.
    DATA bookings TYPE TABLE OF z054906booking_a.

    " Delete Travels
    DELETE FROM z054906travel_a.
    out->write( |Deleted Travels: { sy-dbcnt }| ).

    " Delete Bookings
    DELETE FROM z054906booking_a.
    ...
    " Insert Travels
    INSERT z054906travel_a FROM TABLE @travels.
    out->write( |Inserted Travels: { sy-dbcnt }| ).

    " Insert Bookings
    INSERT z054906booking_a FROM TABLE @bookings.
